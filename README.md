จัดให้ตามคำขอครับ! ในส่วนของแท็บ **3. Spare Parts** ผมได้เพิ่มระบบให้สามารถ **คลิกที่ชื่อระบบ/รุ่นอุปกรณ์ (ในช่องที่วงสีแดง)** เพื่อเปิดหน้าต่าง Modal แสดงรายละเอียดและประวัติการซ่อมบำรุง/เปลี่ยนอะไหล่ที่เกี่ยวข้องกับอุปกรณ์นั้นๆ ได้ทันทีเช่นเดียวกับหน้าแรกครับ

คุณสามารถคัดลอกโค้ดฉบับสมบูรณ์ด้านล่างนี้ไปเซฟทับไฟล์ `.html` เดิมได้เลยครับ:
